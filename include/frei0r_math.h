 ...
 *
 * @param a
 * @return unsigned char 0 if the number was negative. -1 if the number was
 * greater than 255
 */
static inline unsigned char CLAMP0255(int32_t a) {
  return (unsigned char)((((-a) >> 31) & a) | (255 - a) >> 31);
}
#endif
...
/* This version of INT_MULT3 is very fast, but suffers from some slight roundoff
   errors.  It returns the correct result 99.987 percent of the time */
#ifndef INT_MULT3
#define INT_MULT3(a, b, c, t)                                                  \
  ((t) = (a) * (b) * (c) + 0x7F5B, ((((t) >> 7) + (t)) >> 16))
#endif
...
uint8_t MAX255(uint32_t a) {
  return (uint8_t)(a | ((a & 256) - ((a & 256) >> 8)));
}
#endif
