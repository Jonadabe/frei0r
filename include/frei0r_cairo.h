 ...
 *
 * Sets cairo context to use the defined color paint operations. Switches red
 * and blue channels to get correct color on little endian machines. This method
 * only works correctly on little endian machines.
 */
void frei0r_cairo_set_rgba_LITTLE_ENDIAN(cairo_t *cr, double red, double green,
 ...
 * only works correctly on little endian machines.
 */
void frei0r_cairo_set_rgb_LITTLE_ENDIAN(cairo_t *cr, double red, double green,
                                        double blue) {
 ...
 * @alpha: opacity of color, 0 -1
 *
 * Sets color stop for cairo patterns. Switches red and blue channels to get
 * correct color on little endian machines. This method only works correctly on
 * little endian machines.
 */
void freior_cairo_set_color_stop_rgba_LITTLE_ENDIAN(cairo_pattern_t *pat,
 ...
 *
 * Converts double range [0 -> 1] to pixel range [-2*dim -> 3*dim]. Input 0.4
 * gives position 0.
 *
 ...
 *
 * Converts double range [0 -> 1] to scale range [0 -> 5]. Input 0.2 gives scale
 * 1.0.
 *
 * Returns: scale
 */
double frei0r_cairo_get_scale(double norm_scale) { return norm_scale * 5.0; }
